...
async def get_per_work_theme_counts(neo4j: "Neo4jConnection") -> dict[str, Any]:
    """Return per-work theme counts and an error state when Neo4j is unavailable.
    ...
    """
    result: dict[str, Any] = {"error": None, "theme_counts": {}}
    try:
