-- Make work_id renames opt-in deferrable while preserving immediate checks by default.
...
-- Reversible: scripts/revert_deferrable_work_id_foreign_keys.sql (rehearsed up→down→up).
